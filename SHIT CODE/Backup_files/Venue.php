  ...
  <div id="header_wrapper">
    ...
    <div id="navcontainer">
      <ul id="navlist">
        ...
        <li id="active"><a href="Venue.php" id="current">Venue</a></li>
...
<div id="left_side">
    <h3 align="center">ICCC 2018 </h3>
<img name="venue_left" src="img/CET190-70.jpg" width="190" height="170" alt="" />
...
var flashyshow=new flashyslideshow({ //create instance of slideshow
	...
	imagearray: [ 
		["img/CET190-70.jpg", "www.cet.ac.in", "", "College of Engineering"],
		["img/RT1.jpg", "http://www.residencytower.com/", "", "Hotel Residency Tower"],
		["img/Hall.jpg", "", "", "Conference Hall"]
	],
...
<!--
  ...
  <div id="content">
	  ...
	  <h3 align="center" class="style1">Conference Venue </h3>
	  <div class='featurebox_center'> 
      <div align="left">
<!--
        <p align="center"><img src="img/banner-mascot.jpg" width="530" height="189" /></p>
		<p align="center"><a target="_blank" href="https://www.google.co.in/maps/place/KTDC+Mascot+Hotel/@8.5091777,76.9498653,19z/data=!3m1!4b1!4m18!1m15!4m14!1m6!1m2!1s0x3b05ba5b28397eb3:0xcbed86006883d944!2sPoojapura,+Thiruvananthapuram,+Kerala!2m2!1d76.9787076!2d8.4916137!1m6!1m2!1s0x3b05bbc5d6111745:0xb306f65532a6d298!2sKTDC+Mascot+Hotel,+Cantonment+House+Rd,+PMG,+Thiruvananthapuram,+Kerala+695033!2m2!1d76.9498653!2d8.5091777!3m1!1s0x3b05bbc5d6111745:0xb306f65532a6d298!6m1!1e1">Mascot Hotel</a></p>
		
      </div>
      <link rel="stylesheet" href="css/menu_tab_style.css" type="text/css">
      <br />
      <h3 align="center" class="style1">More about 
     <div align="center" class="dropdown">

    	 trigger button 
    <button style="font-size:18px">Trivandrum</button>

    	 dropdown menu 
    <ul class="dropdown-menu">
        <li><a target="_blank" href="https://en.wikipedia.org/wiki/Thiruvananthapuram">Wikipedia</a></li>
        <li><a target="_blank" href="http://wikitravel.org/en/Thiruvananthapuram">Wikitravel</a></li>
    </ul>
-->
</div></h3>
