...
<div id="page_wrapper">
  <div id="header_wrapper">
    ...
    <div id="navcontainer">
	  ...
	  <li id="active"><a href="Registration.php">Registration</a></li>
      ...
      <div class='featurebox_center'> 
       <div align="left">
        ...
        <table width="513" border="0">
          <tr bgcolor="#F5FAFA">
            <td width="258"><h4 align="center">Keynote Speaker </h4></td>
            <td width="245"><div align="center">
              </div></td>
          </tr>
<!--          <tr bgcolor="#F5FAFA">
            <td><h4 align="center"><img src="img/sub_pic.png" width="135" height="135" /></h4><br />
            ...
            <td><div align="center">              <strong></strong><br /> 
             <h4 align="center">Subhasis  Chaudhuri</h4><br />
            <p align="center">Deputy Director (AIA) & K.N. Bajaj Chair Professor in Electrical Engineering Indian Institute of Technology Powai,<br /> Bombay 400 076,<br />India</p>
 -->          
            </div></td>
          </tr>
        </table>
