    ...
    <div id="navcontainer">
      <ul id="navlist">
       <li><a href="index.php">Home</a></li>
		...
		<li><a href="OrgCommitee.php">Commitees</a></li>
		<li id="active"><a href="Tutorials.php" id="current">Tutorials</a></li>
        <li><a href="Paper_sub.php">Paper Submition</a></li>
...
Co-sponsor</h3>
  ...
  <div id="content">
      ...
      <h3 align="center" class="style1">Pre-Conference Tutorials</h3>
      <div class='featurebox_center'> 
        <div align="center">
          <p>There will be pre-conference tutorials on current topics in all the three streams - control, communication and computing on <strong>18-11-2015</strong>.</p>
        <p>Details of topics and speakers will be announced soon.</p>
        </div>
      </div>
    <p>&nbsp;  </p>
    <?php
